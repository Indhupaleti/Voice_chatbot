...
def Button_Function():
    ...
    if "joke" in x:
        ...
        b.set("I am voice chatbot")
        bot_screen.update()

    elif "who is your guide" in x:
        b.set("i am guided by vardhini mam")
        bot_screen.update()
...
instruction_img = PhotoImage(file = r"C:\Users\palet\OneDrive\Desktop\Chatbot--main\chatbot icon.png")
...
img_human_bot= PhotoImage(file=r"C:\Users\palet\OneDrive\Desktop\Chatbot--main\human bot.png")
...
img_robot_bot= PhotoImage(file=r"C:\Users\palet\OneDrive\Desktop\Chatbot--main\robot.png")
...
user_screen.grid(row=1,column=2,ipady=50,padx=20)
...
img_speech = PhotoImage(file=r"C:\Users\palet\OneDrive\Desktop\Chatbot--main\mic.png")
img_speech_main = img_speech.subsample(12,12)

b2 = Button(f1,image=img_speech_main,command = voice_button_function)
b2.grid(row=1,column=4)

img_click = PhotoImage(file=r"C:\Users\palet\OneDrive\Desktop\Chatbot--main\click.png")
